...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "laskinp-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/carlisbad"
  #   chef.validation_client_name = "carlisbad-validator"
  #   chef.validation_key_path = ".chef/carlisbad-validator.pem"
  # end
end
